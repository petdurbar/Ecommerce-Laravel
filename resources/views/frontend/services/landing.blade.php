...
<div class="w-full -my-5  items-center bg-gradient-to-t flex justify-center " style="background-image: linear-gradient(to top, #0028DC, #071d8a);">
    <img src="{{ asset('images/commingsoon2.png') }}" alt="comingsoon" class="w-[600px] " />
</div>
{{-- <section class="bg-gradient-to-t -mx-20 -my-10" style="background-image: linear-gradient(to top, #0028DC, #000E57);"> --}}
    {{-- <div class="container">
