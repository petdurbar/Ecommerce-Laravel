...
@section('page_title', 'Admin -Terms & Condition')
@section('terms_select', 'bg-black text-white')
@section('container')

<div class="">
    <form action="
{{ route('termsandcondition.update',$terms->id) }}
...
@include('admin.includes.messages')
        ...
        <div class="flex flex-col w-[90%] pl-10 pt-6">
            ...
            <textarea name="description" id=""
                ...
                id="" cols="10" rows="5" placeholder="Type SecondSection Description  here">
                {{ $terms->description }}
            </textarea>
            @error('description')
        ...
        <div class="pl-10 pt-4">
            <button type="submit" class="border mt-3 border-primary px-6 py-2 rounded-md mr-2 text-white bg-black ">
                Edit
            </button>
        </div>
    </form>
