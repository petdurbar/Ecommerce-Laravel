                            ...
                            <tr>
                                ...
                                <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                    <img src="{{asset('/uploads/'.$product->featured_image)}}"
                                        alt="herosectionimage" class="oldimage h-12 w-12" />
                                                                    </td>
                                ...
                                {{-- <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                    <p class="text-gray-900 whitespace-no-wrap">{{ $product->product_sku}}</p>
                                </td>

                                <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                    <p class="text-gray-900 whitespace-no-wrap">{{ $product->availablestock }}</p>
                                </td> --}}

                                {{-- <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                    <p class="text-gray-900 whitespace-no-wrap">{{ $product->product_price}}</p>
                                </td> --}}
