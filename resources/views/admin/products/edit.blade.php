                                ...
                                <div class="flex flex-col my-5">
                                    <div>
                                        ...
                                        <div>
                                            ...
                                            <input
                                                ...
                                                name="product_name" value="{{ $product->product_name }}" id="product_name"
                                                placeholder="Type product name here" type="text" />
                                    ...
                                    <div class="">
                                        <label class="block mt-4 text-sm mb-3">
                                            ...
                                            <img src="{{ asset('uploads/' . $product->featured_image) }}" id="imagePreview"
                                                class="imagePreview mt-4" alt="Image Preview"
                                    ...
                                    <textarea id="description" class="outline-none block tinymce w-full mt-1 py-2 text-xs rounded-md border px-3"
                                        placeholder="Type product description here" name="description" rows="3">{{ $product->description }}</textarea>
                                    @error('description')
                                        <div class="invalid-feedback text-red-400 text-sm" style="display: block;">
                                            * {{ $message }}
                                        </div>
                                    ...
                                    <textarea id="specification" class="tinymce outline-none block w-full mt-1 py-2 text-xs rounded-md border px-3"
                                        placeholder="Type product specification here" name="specification" rows="3">{{ $product->specification }}</textarea>
                                    @error('specification')
                                        <div class="invalid-feedback text-red-400 text-sm" style="display: block;">
                                            * {{ $message }}
                                        </div>
                                        ...
                                        <div class="mt-5 bg-white rounded p-3 shadow-lg">
                                            ...
                                            <div class="max-h-screen  overflow-y-scroll w-full">
                                                @foreach (getCategories(0) as $category)
                                                    <div class="mt-2 ml-2">
                                                        <input type="checkbox"
                                                            ...
                                                            name="category_id" class="category-checkbox"
                                                            ...
                                                            @foreach (getCategories($category->id) as $subcategory)
                                                                <div class="ml-5 mt-2">
                                                                    <input type="checkbox" name="category_id"
                                                                        {{ $subcategory->id == $product->category_id ? 'checked' : '' }}
                                                                ...
                                                                @foreach (getCategories($subcategory->id) as $twosubcategory)
                                                                    <div class="ml-12 mt-2">
                                                                        <input type="checkbox" name="category_id"
                                                                            {{ $twosubcategory->id == $product->category_id ? 'checked' : '' }}
                                                                            class="category-checkbox"
                                                                            class="w-[13px] h-[13px] text-blue-600 bg-gray-100 border-gray-300 rounded"
                                                ...
                                                <div class="mx-2 mt-1">
                                                    ...
                                                    <input {{ $product->variation == 1 ? 'checked' : '' }} type="radio"
                                                        name="variation" class="addButtonSection" value="Yes">
                                                    <label for="hasVariationYes">Yes</label>

                                                    <input type="radio" id="" name="variation" value="No"
                                                        {{ $product->variation == 0 ? 'checked' : '' }}
                                                        class="addButtonSection">
                                    ...
                                    <div id="nonVariationSection">
                                        ...
                                        <div>
                                            ...
                                            <div>
                                                ...
                                                <input
                                                    ...
                                                    id="product_sku" value="{{ $product->product_sku }}"
                                                    id="product_sku" type="text" />
                                                @error('product_sku')
                                                    <div class="invalid-feedback text-red-400 text-sm"
                                                        style="display: block;">
                                                        * {{ $message }}
                                        ...
                                        <div>
                                            ...
                                            <div>
                                                ...
                                                <input
                                                    class="text-xs border border-gray-300 p-3 rounded mt-3 focus:border-[#7065d4] hover:border-[#7065d4] w-full"
                                                    name="availablestock" value="{{ $product->availablestock }}"
                                                    placeholder="Type quantity here" id="availablestock"
                                                    type="text" />
                                    ...
                                    {{-- @if ($product->variation == 1)
                                        @foreach ($product_price_variations as $key => $price)
                                            @php
                                                $pvariation = getProductVariation($price->id);
                                            @endphp
                                            <div id="">
                                                <div class="tableItem flex justify-between">
                                                    <div id="" class="flex ">
                                                        @foreach ($attributeGroups as $attv)
                                                            <div
                                                                class="flex items-center mx-5 py-5 border-b border-gray-200 bg-white text-sm">
                                                                <select name="attr[{{ $key }}][]"
                                                                    class="mx-5 py-3 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">
                                                                    @foreach (getAttribute($attv) as $attrvalue)
                                                                        <option
                                                                            {{ in_array($attrvalue->id, $pvariation) ? 'selected' : '' }}
                                                                            value="{{ $attrvalue->id }}">
                                                                            {{ $attrvalue->name }}
                                                                        </option>
                                                                    @endforeach
                                                    ...
                                                    <label class="block mt-4 text-sm mb-3">
                                                        ...
                                                        <input type="file" name="images[]" id="image"
                                                            ...
                                                            placeholder="Choose an image">
                                                        <img id="image" src="{{ asset('uploads/' . $price->image) }}"
                                                            class="imagePreview mt-4" alt="Image Preview"
                                                            style="max-width: 15%; height: auto;">
                                                    </label>
                                                    ...
                                                    <div class=" py-5 border-b border-gray-200 bg-white text-sm">
                                                        <input type="number" value="{{ $price->quantity }}"
                                                            name="quantity[]" class="quantity-input border p-2" />
                                                    </div>
                                                    <div class=" py-5 border-b border-gray-200 bg-white text-sm">

                                                        <input type="number" value="{{ $price->price }}" name="price[]"
                                                            class="price-input border p-2" />
                                                    </div>
                                                    <div class="py-5 border-b border-gray-200 bg-white text-sm">

                                                        <input type="text" name="sku[]" value="{{ $price->sku }}"
                                    ...
                                    <div id="additionalSection" style="display: none;"
                                        class="bg-white shadow-md p-5 test-test">
                                                            ...
                                                            @foreach ($product_price_variations as $key => $price)
                                                                ...
                                                                <div class="tableItem flex justify-between">
                                                                    ...
                                                                    <label class="block mt-4 text-sm mb-3">
                                                                        ...
                                                                        <input type="file"
                                                                            name="old_images[{{ $price->id }}]"
                                                                            id="image"
                                                                            class="imageInput block w-full mt-1 text-sm border-green-600 focus:border-green-400 focus:outline-none focus:shadow-outline-green form-input"
                                                                            placeholder="Choose an image">
                                                                        <img id="image"
                                                                            src="{{ asset('uploads/' . $price->image) }}"
                                                                            class="imagePreview mt-4" alt="Image Preview"
                                                                            style="max-width: 15%; height: auto;">
                                                                    </label>
 ...
 --}}
                                    ...
                                    <div>
                                        ...
                                        <div>
                                            ...
                                            <input
                                                class="text-xs border border-gray-300 p-3 rounded mt-3 focus:border-[#7065d4] hover:border-[#7065d4] w-full"
                                                name="meta_title" value="{{ $product->meta_title }}" id="meta_title"
                                                placeholder="Type Meta Title" type="text" />
                                            @error('meta_title')
                                                <div class="invalid-feedback text-red-400 text-sm" style="display: block;">
                                                    * {{ $message }}
                                                </div>
                                    ...
                                    <textarea class="text-xs border border-gray-300 p-3 rounded mt-3 focus:border-[#7065d4] hover:border-[#7065d4] w-full"
                                        name="meta_description" placeholder="Type Meta description" type="text">{{ $product->meta_description }}</textarea>
    ...
    <script>
        $(function() {
            const variation = $('input[name="variation"]:checked').val();
            if (variation == 'Yes') {
        ...
        $('#saveBtn').on('click', function() {
            ...
            $.ajax({
                ...
                url: "{{ url('admin/update/variations') }}/" + "{{ $product->id }}",
                data: formData,
                contentType: false,
                processData: false,
                success: function(data) {
