...
@section('container')
    <div class="flex gap-4">
        <a href="{{ route('secondbanner.index') }}">
    ...
    <div class="row m-t-30">
        <form method="post" action="{{ route('secondbanner.update', $secondbanner->id) }}" enctype="multipart/form-data">
            @csrf
            @method('put')
                ...
                <div class="flex flex-col my-5">
                    <div>
                        ...
                        <div>
                            <input
                                ...
                                value="{{ $secondbanner->banner_name }}" />
                            @error('banner_name')
                    ...
                    <div class="mt-3">
                        ...
                        <div
                            ...
                            <img class="" src="{{ asset('/images/banner/' . $secondbanner->banner_image) }}" alt="Card"
                    ...
                    <div>
                        ...
                        <div>
                            <input
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                                name="banner_link" placeholder="Type banner link here" type="text" value="{{ $secondbanner->banner_link }}"
                    ...
                    <div>
                        ...
                        <div>
                            <input  type="radio" id="yes" name="mobileview" value="1" {{ $secondbanner->mobileview == '1' ? 'checked' : '' }}>
                            <label for="yes">Yes</label>
                            <input  type="radio" id="no" name="mobileview" value="0" {{ $secondbanner->mobileview == '0' ? 'checked' : '' }}>
